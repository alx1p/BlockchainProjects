...
def multisig_scriptSig(txin, txout, txin_scriptPubKey):
    ...
    return [
        OP_0, cust3_sig, bank_sig  # need throwaway stack item for CHECKMULTISIG bug
        # mandatory syntax implemented is dummy, cust sigs, bank sig LAST
    ]
    ######################################################################
...
if __name__ == '__main__':
    ...
    txid_to_spend = (
        '0dcc6668b64255d08ff6b7239fad367f68e33f4ac57d2d32f3bbaac8b7028b42')
